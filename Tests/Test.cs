...
namespace Tests
{
	...
	public class Test
	{
		...
		public void checkIfStringIsGenerated() {
			Assert.AreEqual(generator.getChromosomeString().GetType(), typeof(string));
		}
		[Test()]
		public void resolveUndersizedStringRequest() {
			string chromo = generator.getChromosomeString (2);
		...
		public void resolveArgNotMultipleOfFour() {
			string chromo = generator.getChromosomeString (11);
			Assert.AreEqual(true,  (chromo.Length % 4 == 0));

			chromo = generator.getChromosomeString (1);
			Assert.AreEqual(true,  (chromo.Length % 4 == 0));

			chromo = generator.getChromosomeString (666);
			Assert.AreEqual(true,  (chromo.Length % 4 == 0));

			chromo = generator.getChromosomeString (0);
			Assert.AreEqual(true,  (chromo.Length % 4 == 0));
		}
		[Test()]
		public void retrieveManyRandomString() {
			...
			for (int i = 0; i < SAMPLESIZE; ++i)
				strList.Add (generator.getChromosomeString ());
